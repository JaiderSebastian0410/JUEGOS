...
(function () {
  ...
  const ENEMY_TYPES = Object.freeze([
    { name: 'Morg', shape: 'circle', color: '#ff3366', size: 20, hp: 1, speed: 1.1, pts: 10 },
    { name: 'Stinger', shape: 'triangle', color: '#e67e22', size: 16, hp: 1, speed: 2.2, pts: 15 },
    { name: 'Titan', shape: 'square', color: '#9b59b6', size: 30, hp: 3, speed: 0.7, pts: 30 },
    { name: 'Vanguard', shape: 'pentagon', color: '#2ecc71', size: 24, hp: 2, speed: 1.2, pts: 25 },
    { name: 'Wasp', shape: 'hexagon', color: '#f1c40f', size: 18, hp: 2, speed: 1.6, pts: 20 },
    { name: 'Pulsar', shape: 'star', color: '#3498db', size: 26, hp: 4, speed: 1.0, pts: 40 },
    { name: 'Razor', shape: 'diamond', color: '#1abc9c', size: 14, hp: 2, speed: 2.6, pts: 35 },
    { name: 'Interceptor', shape: 'cross', color: '#ff007f', size: 22, hp: 5, speed: 1.3, pts: 50 },
    { name: 'Goliath', shape: 'octagon', color: '#ecf0f1', size: 35, hp: 8, speed: 0.6, pts: 80 },
    { name: 'Overlord', shape: 'ufo', color: '#f1c40f', size: 40, hp: 12, speed: 0.9, pts: 150 },
  ]);
  ...
  function spawnEnemies() {
    ...
    const baseSpeed = selectedType.speed + score * 0.0001;
  ...
  function drawEntities() {
    ...
    for (const e of enemies) {
      ...
      ctx.lineWidth = 2.5;
      ctx.rotate(frame * 0.04 * (e.speed > 1.5 ? 2 : 1));
